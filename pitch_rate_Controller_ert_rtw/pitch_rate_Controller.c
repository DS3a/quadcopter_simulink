...
void pitch_rate_Controller_step(void)
{
   ...
   *  Sum: '<S42>/Sum'
   */
  pitch_rate_Controller_Y.y = 0.0752024185169063 * pitch_rate_Controller_U.u +
   ...
   *  Inport: '<Root>/u'
   */
  pitch_rate_Controller_DW.Integrator_DSTATE += 0.0131599023132309 *
    pitch_rate_Controller_U.u * 0.002;
}
